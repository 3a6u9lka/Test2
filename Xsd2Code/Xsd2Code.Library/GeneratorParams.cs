...
namespace Xsd2Code.Library
{
    ...
    public class MiscellaneousParams : GeneratorParamsBase
    {
        ...
        [Category("Behavior")]
        [DefaultValue(true)]
        [Description("Indicating to exclude class generation types imported into schema.")]
    ...
    public class GeneratorParams
    {
        ...
        /// Type of collection
        /// </summary>
        private CollectionType collectionObjectTypeField = CollectionType.Array;
        ...
        public GeneratorParams()
        {
            ...
            this.Miscellaneous.ExcludeImportedTypes = true;
            this.Miscellaneous.ExcludeIncludedTypes = true;
            this.Miscellaneous.EnableSummaryComment = true;
            this.Serialization.GenerateXmlAttributes = true;
